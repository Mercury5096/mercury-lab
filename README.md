...
- Current focus: maintain the completed eight-room desktop factory foundation and prepare room-by-room interaction polish
...
- `src/styles/` - factory-specific CSS split by shared cutaway layout and room scene animation layers
